...
public class DecryptAPIService extends EDAPIService {
    EncryptionService encryptionService;
    private WriteToFileDecrypt writeToFileDecrypt;
    ArrayList<KeyValueObject> decryptedKeyValueObjectsArrayList;
    public void createFileAddValuesEncrypted(){
        //create file
        createFileObjHelper();
    ...
    public  void decryptStringServices(KeyValueObjectList keyValueObjectList) throws Exception{
        ...
        this.decryptedKeyValueObjectsArrayList = keyValueObjectsArrayList;
    }

    public ArrayList<KeyValueObject> getDecryptedKeyValueObjectsArrayList(){
        return  this.decryptedKeyValueObjectsArrayList;
    }
